  ...
  return (
    <section className='contenedor' id='contacto'>
        ...
        <article className='tarjeta'>
            ...
            <div className='circulo'></div>
            <div className='tarjeta-interna'>
                <a className='red-social' href='https://www.instagram.com/buitrago.eth' target='_blank'>
                ...
                <a className='red-social' href='https://twitter.com/buitrago91' target='_blank'>
                ...
                <a className='red-social' href='https://wa.link/wvdxwv' target='_blank'>
                ...
                <a className='red-social' href='https://linktr.ee/buitrago91' target='_blank'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-layers-linked" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
